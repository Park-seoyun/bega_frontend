  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Loading/Error State */}
        {loading && <p className="text-center text-gray-600">프로필을 로딩 중입니다...</p>}
        {error && <p className="text-center text-red-500">{error}</p>}

        {/* Profile Section (로딩 중이 아닐 때만 표시) */}
        {!loading && (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)} // 필요시 수정 가능하도록 유지
                  className="w-full"
                  placeholder="이메일을 입력하세요"
                  disabled={true} // 일반적으로 이메일은 수정 불가
                />
              </div>
          ...
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <div 
                  className="w-4 h-4 rounded-full" 
                  style={{ backgroundColor: TEAM_DATA[savedFavoriteTeam]? TEAM_DATA[savedFavoriteTeam].color  : TEAM_DATA['없음'].color }}
                />
